# 🚀🌐🔐 Anthropic - Claude Code: `Claude Code 101`
...
Antes de comenzar a trabajar directamente con **Claude Code**, es importante entender el ecosistema general de **Claude** y las distintas formas en las que podemos interactuar con sus modelos.

Cuando ingresamos a **Claude**, normalmente encontraremos **tres tipos principales de interacción** disponibles en la interfaz:
...
* ⚙️ Automatice tareas
* 🔗 Integre workflows reales
* 📊 Trabaje con datos reales
...
* 🖥️ Conectar sistemas externos propios
...
> 📘 Instrucciones estructuradas o workflows predefinidos que guían el comportamiento del modelo.

En la práctica, los **Skills** permiten:

* 📏 Estandarizar tareas
* 🎯 Reducir errores
* 🔁 Repetir workflows de manera consistente
* ⚙️ Ejecutar tareas complejas de forma controlada



## ❓ Clarification Behavior (Comportamiento normal del modelo)

Es importante entender que cuando Claude no tiene suficiente información para completar una tarea, puede:

* ❓ Hacer **clarifying questions**
